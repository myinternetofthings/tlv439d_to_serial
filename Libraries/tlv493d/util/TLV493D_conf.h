...
#define TLV493D_B_MULT 				0.130f // uncalibrated TLV493D-A1B6 constant
#define TLV493D_TEMP_MULT 		0.28f  // uncalibrated TLV493D-A1B6 constant
#define TLV493D_TEMP_OFFSET 		270  // roughly calibrated TLV493D-A1B6 constant
...
const RegMask_t regMasks[] = {
	...
	{ REGMASK_WRITE, 3, 0x40, 6 },		// W_LP_PERIOD
...
// fast mode, low-power mode, low-power period, measurement time
